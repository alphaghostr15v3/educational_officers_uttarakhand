...
<head>
    ...
    <title>Login - Educational Ministerial Officers Uttarakhand</title>
        ...
        <div class="login-card">
            ...
            <div class="login-body">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input id="email" type="email" class="form-control border-start-0 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="admin@example.com">
                        </div>
                        @error('email')
                ...
                <div class="mt-4 pt-3 border-top">
                    <p class="text-center small fw-bold text-muted mb-3 text-uppercase" style="letter-spacing: 1px;">Access Portals</p>
                    <div class="portal-links">
                        <a href="{{ route('admin.login') }}" class="portal-btn">Admin Portal</a>
                        <a href="{{ route('employee.login') }}" class="portal-btn">Employee Portal</a>
                        <a href="{{ route('school.login') }}" class="portal-btn">School Portal</a>
                        <a href="{{ url('/') }}" class="portal-btn">Public Portal</a>
                    </div>
                </div>
            </div>

            <div class="login-footer">
                <p class="mb-0 text-muted small">&copy; {{ date('Y') }} Association Uttarakhand. All rights reserved.</p>
            </div>
        </div>
    </div>
</body>
