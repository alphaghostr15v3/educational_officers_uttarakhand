...
class AdminWorkFormController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'promotion_order_number' => 'nullable|string|max:255',
            'promotion_order_date' => 'nullable|date',
            'dearness_percentage' => 'nullable|numeric|min:0|max:100',
            'from_date' => 'nullable|date',
            'go_year' => 'nullable|string|max:4',
